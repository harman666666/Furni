...
var Product: Mongoose._mongoose.IModelConstructor<{}> & EventEmitter.EventEmitter = require('../models/product.database.model');
...
createNewProduct(product: ProductModel): any {
    ...
    var entry = new Product({
        ...
        collateralAmount: product.collateralAmount,  //HASH THE PASSWORD IN THE DB
